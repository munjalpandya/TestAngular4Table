...
AppModule = __decorate([
    core_1.NgModule({
        ...
        declarations: [app_component_1.AppComponent, user_component_1.UserComponent, home_component_1.HomeComponent, user_pipe_1.UserFilterPipe, search_component_1.SearchComponent, manageuser_component_1.ManageUser,
            datagrid_component_1.DataGrid, format_1.Format, orderby_1.OrderBy, userlist_component_1.UserListComponent, samplepagination_component_1.SamplePaginationComponent, pagination_component_1.PaginationComponent, addtolist_component_1.AddToList, md_component_1.MD, md1_component_1.MD1, uploadpic_component_1.UploadPic
        ],
